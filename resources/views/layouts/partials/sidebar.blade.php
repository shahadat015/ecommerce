<div class="left-sidenav">
    <div class="main-icon-menu">
        <nav class="nav">
            ...
            @can('CRUD PRODUCT')
            <a href="#MetricaEcommerce" class="nav-link" data-toggle="tooltip-custom" data-placement="top" title="" data-original-title="Products">
            ...
            @endcan
            @can('RD ORDER')
            <a href="#MetricaCrypto" class="nav-link" data-toggle="tooltip-custom" data-placement="top" title="" data-original-title="Sales">
    ...
    <div class="main-menu-inner">
        <div class="menu-body slimscroll">
            <div id="MetricaAnalytic" class="main-icon-menu-pane">
                ...
                <ul class="nav">
                    <li class="nav-item"><a class="nav-link" href="{{ url('/admin') }}"><i class="dripicons-meter"></i>Dashboard</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ url('/admin/setting') }}"><i class="dripicons-gear"></i>Settings</a></li>
                </ul>
            </div>
            <!-- end Analytic -->
            <div id="MetricaEcommerce" class="main-icon-menu-pane">
                ...
                <ul class="nav">
                    <li class="nav-item"><a class="nav-link" href="{{ url('/admin/products') }}"><i class="dripicons-view-apps"></i>Catalog</a></li>
            ...
            <div id="MetricaProject" class="main-icon-menu-pane">
                ...
                <ul class="nav">
                    <li class="nav-item"><a class="nav-link" href="{{ url('/admin/media') }}"><i class="dripicons-camera"></i>Media</a></li>
                </ul>
            </div>
            <!-- end Ecommerce -->
            ...
            <div id="MetricaAuthentication" class="main-icon-menu-pane">
                ...
                <ul class="nav">
                    <li class="nav-item"><a class="nav-link" href="{{ url('/admin/users') }}"><i class="dripicons-user-group"></i>Users</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ url('/admin/roles') }}"><i class="dripicons-user-id"></i>Roles</a></li>
