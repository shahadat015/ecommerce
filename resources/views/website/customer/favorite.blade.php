                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-xl-6 col-md-6 col-sm-6">
                                            <div class="order_status_item_info">
                                                <a href="{{url('product/'.$product->id .'/'.$product->slug)}}"><h4>{{$product->name}}</h4></a>
                                                <h5>Price: Tk {{$product->price}}</h5>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-md-3 col-sm-3">
                                            <div class="order_status_item_info_status">
                                                <a href="{{url('/unfavorite/'.$product->id)}}">
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="pagination_info">
                                    <p>Showing {{$favorite_products->count()}} of  {{$favorite_products->total()}} Orders</p>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6">
