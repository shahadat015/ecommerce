        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="mt-2 header-title float-left">Pages</h4>
                    <a class="btn btn-info btn-sm float-right" href="{{ route('admin.pages.create') }}"><i class="mdi mdi-plus-circle-outline"></i> Create Page</a>
                    <button class="btn-delete btn btn-danger btn-sm float-right mr-2" data-url="{{ route('admin.page.destroy') }}" disabled><i class="mdi mdi-delete"></i> Delete</button>
                </div>
                <div class="card-body">
