        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="mt-2 float-left">Features</h4>
                    <a class="btn btn-info btn-sm float-right" href="{{ route('admin.attributes.create') }}"><i class="mdi mdi-plus-circle-outline"></i> Create Features</a>
