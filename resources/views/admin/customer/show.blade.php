        ...
        <div class="col-10">
            <div class="card">
                <div class="card-header">
                    <h4 class="mt-2 header-title float-left">Show Customer</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-4 align-self-center mb-3 mb-lg-0">
                                <div class="met-profile-main">
                                    <div class="met-profile-main-pic">
                                        @if($customer->image)
                                        <img src="{{ asset($customer->image) }}" alt="" class="rounded-circle" width="120">
                                        @else
                                    ...
                                    <div class="met-profile_user-detail">
                                        <h5 class="met-user-name">{{ $customer->name }}</h5>
                            ...
                            <div class="col-lg-4 ml-auto mt-4">
                                <ul class="list-unstyled personal-detail">
                                    <li class=""><i class="dripicons-phone mr-2 text-info font-18"></i> <b>Phone </b>: {{ $customer->phone ?? 'No Number' }}</li>
                                    <li class="mt-2"><i class="dripicons-mail text-info font-18 mt-2 mr-2"></i> <b>Email </b>: {{ $customer->email }}</li>
                                    <li class="mt-2"><i class="dripicons-location text-info font-18 mt-2 mr-2"></i> <b>Address</b> : {{ $customer->address ?? "No Address" }}</li>
                                </ul>
                            </div>
                            <!--end col-->
                        </div>
